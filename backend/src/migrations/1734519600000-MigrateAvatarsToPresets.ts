...
export class MigrateAvatarsToPresets1734519600000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const usersWithoutAvatar = await queryRunner.query(
      'SELECT id FROM users WHERE avatar IS NULL'
    );

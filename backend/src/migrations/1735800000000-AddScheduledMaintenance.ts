...
export class AddScheduledMaintenance1735800000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    const scheduledFk = ticketsTable?.foreignKeys.find(
      fk => fk.columnNames.indexOf('scheduled_maintenance_id') !== -1
    );
    if (scheduledFk) {

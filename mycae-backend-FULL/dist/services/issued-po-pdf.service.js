...
exports.IssuedPOPDFService = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class IssuedPOPDFService {
    /**
     ...
     */
    static async generateIssuedPOPDF(issuedPO) {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                doc.font('Helvetica').text(new Date(issuedPO.issue_date).toLocaleDateString('en-GB', {
                    day: 'numeric',
                    month: 'short',
                    year: 'numeric',
                }), margin + 100, poDetailsY + 15);
                ...
                const footerText = settings.po_footer || 'This is a computer-generated document. No signature is required.';
     ...
     */
    static async savePDF(issuedPO, pdfBuffer) {
...
exports.IssuedPOPDFService = IssuedPOPDFService;
IssuedPOPDFService.CACHE_DIR = path.join(__dirname, '../../uploads/pdfs/cache');
IssuedPOPDFService.CACHE_EXPIRY_MS = 48 * 60 * 60 * 1000; // 48 hours
//# sourceMappingURL=issued-po-pdf.service.js.map
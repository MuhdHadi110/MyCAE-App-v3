...
async function runIntegrityChecks() {
    ...
    try {
        ...
        const orphanedTimesheets = await database_1.AppDataSource.query(`
    ...
    `);
        ...
        const orphanedInvoices = await database_1.AppDataSource.query(`
    ...
    `);
        ...
        const invalidCheckouts = await database_1.AppDataSource.query(`
    ...
    `);
        ...
        const negativeInventory = await database_1.AppDataSource.query(`
    ...
    `);
        ...
        const invalidTimesheets = await database_1.AppDataSource.query(`
    ...
    `);
        ...
        const invalidInvoices = await database_1.AppDataSource.query(`
    ...
    `);
        ...
        const orphanedTickets = await database_1.AppDataSource.query(`
    ...
    `);
        ...
        const invalidProjects = await database_1.AppDataSource.query(`
...
async function cleanOldBackups(dir, retentionDays) {
    ...
    for (const file of files) {
        if (!file.startsWith('mycae-backup-'))
            continue;

        ...
        const users = [
            {
                ...
                password_hash: await bcryptjs_1.default.hash('john123', 10),
                role: User_1.UserRole.ENGINEER,
            ...
            },
            {
                ...
                password_hash: await bcryptjs_1.default.hash('sarah123', 10),
                role: User_1.UserRole.SENIOR_ENGINEER,
                department: 'Engineering',
            ...
            },
            {
                ...
                password_hash: await bcryptjs_1.default.hash('mike123', 10),
                role: User_1.UserRole.PRINCIPAL_ENGINEER,
                department: 'Engineering',
            ...
            },
            {
                ...
                password_hash: await bcryptjs_1.default.hash('lisa123', 10),
                    ...
                    const projectList = [
                        {
                            ...
                            status: Project_1.ProjectStatus.ONGOING,

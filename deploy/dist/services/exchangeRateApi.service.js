...
exports.ExchangeRateApiService = void 0;
...
class ExchangeRateApiService {
    ...
    static async importRates() {
        ...
        for (const [currency, rate] of Object.entries(rates)) {
            await currency_service_1.CurrencyService.setExchangeRate(currency, rate, today, 'api' // Source is API
            );
        }
    }
}
...
ExchangeRateApiService.BASE_URL = 'https://api.frankfurter.app';
//# sourceMappingURL=exchangeRateApi.service.js.map